/**
 * ITU/E.164 country calling codes for the phone-number field's country
 * selector, shared by every enquiry form on the site (Contact, Hajj
 * registration) so they all offer the same list. UAE is pinned first
 * since it's this business's home market; the rest are alphabetical by
 * country name.
 */
