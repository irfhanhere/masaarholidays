...
// Outside both the (site) and admin layouts, so it gets its own
// WhatsAppTemplatesProvider rather than relying on either of theirs.
    ...
    <WhatsAppTemplatesProvider>
      <div className="flex min-h-screen flex-col items-center justify-center gap-6 bg-warm-ivory px-6 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          <WhatsAppButton templateKey="general">WhatsApp Us</WhatsAppButton>
          <a
