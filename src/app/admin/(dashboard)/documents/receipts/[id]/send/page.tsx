...
export const metadata: Metadata = { title: "Send Receipt | Masaar Admin", robots: { index: false } };

export default async function SendReceiptPage({ params }: { params: Promise<{ id: string }> }) {
