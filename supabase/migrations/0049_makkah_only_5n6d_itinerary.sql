-- Migration: 0049_makkah_only_5n6d_itinerary.sql
-- Per Irfhan's direct instruction: apply the client's "5-Night/6-Days
-- Makkah & Madinah Split Package" itinerary content to the Makkah-only
-- 5 Nights / 6 Days configurations as well, so Product Option 1 no longer
-- shows the "being finalized" placeholder for that duration.
--
...
where journey_type = 'makkah_only' and duration_label = '5 Nights / 6 Days';
